...
def pre_process2(roi_list,armor_color:str)->list:
    ...
    return out,time
@timing
def pre_process3(roi_transform_list:list,armor_color:str='red',strech_max:int|None=None,trace:bool=True)->list:
    '''
    @timing\n
    return roi_single_list,time
    '''
...
def gray_stretch(image,strech_max:int|None=None):
